<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Counters_pag.aspx.cs" Inherits="Ejercicio_Gabriel_F.views.Counters_pag" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
     <h1 class="texta" style="font-family: 'Tourney', cursive;">Counters</h1>
   
    <div class="container  p-2 " style="margin-top:25px; "  >
        ...
        <div class="row">
            ...
            <div class="col-xl-2">
                    ...
                    <div class="container1">
                        <img src="../assets/img/champs/tarjetas/kaisa_c.jpg" alt="Avatar" class="image1">
                         <asp:Button runat="server"  cssclass="btnI" Text="Ver Counter" />
            ...
            <div class="col-xl-2">
                    ...
                    <div class="container1">
                        ...
                        <asp:Button runat="server" onclick="Bt3" cssclass="btnI" Text="Ver Counter" />
  ...
  <div class="p-2 bg-transparent flex-fill">
      <h2 class="text-center bgC" runat="server" id="c1"></h2>
       <img runat="server" id="imgc1" src="l" alt="Avatar" class="image2">
